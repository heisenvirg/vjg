...
const projects: Project[] = [
  ...
  },
  {
    ...
    category: "AI Automation · Make.com · OpenAI",
    year: "2025",
    desc: "Make.com automation that monitors Gmail, classifies emails via OpenAI into 5 categories (Prospect, Client, Priority, Admin, Non-Priority), auto-applies Gmail labels, and generates context-aware draft replies with subject threading. Smart filtering skips newsletters. Delivered with French docs and exportable JSON blueprint.",
    tags: ["Make.com", "OpenAI", "Gmail API", "AI Automation"],
    color: "bg-[#1A0030]",
    accent: "#9333EA",
    image: "/make-email-assistant.png",
    filters: ["AI Automation"],
    details: {
      goal: "Build an AI email management system for an SMB client — automatically classify every incoming email and generate context-aware draft replies, with zero manual inbox work.",
      built: [
        "Gmail monitoring via Make.com running every 15 minutes",
        "OpenAI classifying emails into 5 categories: Prospect, Client, Priority, Admin, Non-Priority",
        "Auto-applying Gmail labels per category for instant inbox organization",
        "Context-aware draft reply generation with full subject threading",
        "Smart filtering to skip drafts for newsletters and automated notifications",
        "Centralized variable architecture for easy duplication across future clients",
        "French documentation and exportable JSON blueprint delivered",
      ],
      result: "Client confirmed: \"Les classifications se font correctement et la qualité des brouillons générés est conforme à ce que j'attendais. Merci pour le travail, c'est top.\" — zero manual inbox work, fully automated.",
    },
  },
  {
    num: "15",
    title: "Zapier Email Automation",
    category: "AI Automation · Zapier · OpenAI",
    year: "2025",
    desc: "Zapier workflow connecting Gmail, OpenAI, Notion, and Telegram. Monitors new emails, generates AI summaries and draft replies, logs everything to a Notion database, creates the draft directly in Gmail, and fires a Telegram alert — all without manual input.",
    tags: ["Zapier", "OpenAI", "Gmail", "Notion", "Telegram"],
    color: "bg-[#1A0800]",
    accent: "#FF4500",
    image: "/zapier-email-automation.png",
    filters: ["AI Automation"],
    details: {
      goal: "Automate email triage end-to-end — AI summaries, smart categorization, Gmail draft creation, Notion logging, and instant Telegram alerts — eliminating manual inbox management.",
      built: [
        "Gmail trigger watching for new emails every 15 minutes",
        "OpenAI generating email summary, category tag, and context-aware draft reply",
        "Notion database logging with full email details, AI summary, and category",
        "Auto-draft creation directly in Gmail for quick human review before sending",
        "Telegram notification fired instantly on successful draft creation",
        "Filter step for routing logic and edge case handling",
      ],
      result: "Every new email is summarized, categorized, logged to Notion, draft-replied in Gmail, and flagged in Telegram — fully automated with no manual input required.",
    },
  },
  {
    num: "16",
    title: "Real Estate Lead Qualification Bot",
    category: "AI Automation · Make.com · CRM",
    year: "2026",
    desc: "Make.com pipeline that captures real estate form submissions into Google Sheets, uses OpenAI to qualify each lead as Hot, Warm, or Cold, updates the sheet with the result, then routes personalized email sequences across 6 paths split by temperature and buyer vs. seller intent.",
    tags: ["Make.com", "OpenAI", "Google Sheets", "CRM", "Lead Management"],
    color: "bg-[#001A08]",
    accent: "#10B981",
    image: "/lead-qualification-bot.png",
    filters: ["AI Automation"],
    details: {
      goal: "Eliminate manual lead screening for a real estate client — instantly qualify every buyer and seller inquiry from the web form and automatically send the right response based on lead temperature.",
      built: [
        "Google Sheets monitoring for new form submissions (name, phone, email, intent, property type, price range)",
        "OpenAI scoring each lead as Hot, Warm, or Cold based on submission data",
        "JSON parser for structured AI output feeding into routing logic",
        "Google Sheets row update with AI qualification score",
        "Smart router splitting by temperature (Hot/Warm/Cold) and intent (Buy vs. Sell) — 6 email paths total",
        "Personalized email sequences for each path: Hot Lead Buy, Hot Lead Sell, Warm Lead Buy, Warm Lead Sell, Cold Lead Buy, Cold Lead Sell",
      ],
      result: "Hot buyers and serious sellers get instant priority follow-up. Cold leads receive appropriate nurture emails. Zero manual screening — every inquiry handled automatically within minutes of submission.",
    },
  },
];
